...
% LEFT PLOT -------------------------------------------------------
   ...
   % Wild Type
       ...
       ForceValues(find(isnan(ForceValues))) = 0;
       %ForceValues = smoothdata(ForceValues,'gaussian',10);
       P2 = plot( VelocityValues, ForceValues,'.'); hold on
...
% MG 2+
       ...
       ForceValues(find(isnan(ForceValues))) = 0;
       %ForceValues = smoothdata(ForceValues,'gaussian',10);
       P3 = plot( VelocityValues, ForceValues,'.'); hold on
       ...
       ForceValues(find(isnan(ForceValues))) = 0;
       %ForceValues = smoothdata(ForceValues,'gaussian',10);
       P4 = plot( VelocityValues, ForceValues,'.'); hold on      
        hold off
...
%         xticks(fliplr(k_a))
%        
        legend([P1,P2,P3,P4],'Wild type, \it{k} = 1.00 pN/nm',...
                              'Wild type, \it{k} = 0.01 pN/nm',...
                              'Mn^{2+}, \it{k} = 1.00 pN/nm',...
                              'Mn^{2+}, \it{k} = 0.01 pN/nm',...
                              'Location','south','FontSize',LFontSize,'NumColumns',2)
        legend boxoff
...
% RIGHT PLOT -------------------------------------------------------
   ...
   % Wild Type
       ...
       VelocityValues(find(isnan(VelocityValues))) = 0;
       %VelocityValues = smoothdata(VelocityValues,'gaussian',10);
       IntegrinValues = LigatedIntegrins(:,AdhesionIndex(1),1);
       IntegrinValues = [IntegrinValues{:}];
       IntegrinValues = IntegrinValues(:);
       IntegrinValues(find(isnan(IntegrinValues))) = 0;
       %ForceValues = smoothdata(ForceValues,'gaussian',10);
       P1 = plot( VelocityValues, IntegrinValues,'.'); hold on
       ...
       VelocityValues(find(isnan(VelocityValues))) = 0;
       %VelocityValues = smoothdata(VelocityValues,'gaussian',10);
       IntegrinValues = LigatedIntegrins(:,AdhesionIndex(2),1);
       IntegrinValues = [IntegrinValues{:}];
       IntegrinValues = IntegrinValues(:);
       IntegrinValues(find(isnan(IntegrinValues))) = 0;
       %ForceValues = smoothdata(ForceValues,'gaussian',10);
       P2 = plot( VelocityValues, IntegrinValues,'.'); hold on
...
% MG 2+
       ...
       VelocityValues(find(isnan(VelocityValues))) = 0;
       %VelocityValues = smoothdata(VelocityValues,'gaussian',10);
       IntegrinValues = LigatedIntegrins(:,AdhesionIndex(1),2);
       IntegrinValues = [IntegrinValues{:}];
       IntegrinValues = IntegrinValues(:);
       IntegrinValues(find(isnan(IntegrinValues))) = 0;
       %ForceValues = smoothdata(ForceValues,'gaussian',10);
       P3 = plot( VelocityValues, IntegrinValues,'.'); hold on
       ...
       VelocityValues(find(isnan(VelocityValues))) = 0;
       %VelocityValues = smoothdata(VelocityValues,'gaussian',10);
       IntegrinValues = LigatedIntegrins(:,AdhesionIndex(2),2);
       IntegrinValues = [IntegrinValues{:}];
       IntegrinValues = IntegrinValues(:);
       IntegrinValues(find(isnan(IntegrinValues))) = 0;
       %ForceValues = smoothdata(ForceValues,'gaussian',10);
       P4 = plot( VelocityValues, IntegrinValues,'.'); hold on      
        hold off
        
        set(gca,'LineWidth',LW,'YScale','linear','XMinorTick','off','FontSize',20)
        xlim([0,400])
        %ylim([5E-2,40]) 
       
            
       xlabel('Velocity (nm/s)','FontWeight','bold','FontSize',XFontSize)
       ylabel('Percent ligated integrin (%)','FontWeight','bold','FontSize',YFontSize)
%         xticks(fliplr(k_a))
%        
        legend([P1,P2,P3,P4],'Wild type, \it{k} = 1.00 pN/nm',...
                              'Wild type, \it{k} = 0.01 pN/nm',...
