function [FALconnections,count] = PlotFilamentsAndMembrane(TimeVec,nth,count,Filaments,Membrane,Adhesions,Ligands,FALconnections,FH,AH1,AH2,AH3,t,nMono,nAdhes,MemVel,index,TV2,ModelParameters, AdhesionTensions,MeanTensions)
