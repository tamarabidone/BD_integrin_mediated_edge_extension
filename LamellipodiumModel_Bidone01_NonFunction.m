...
% Special Conditions (or edits to ModelParameters) ==============================================================
    ...
    ModelParameters.CytoplasmViscosity = 1e4 * 0.001; % Pascal * seconds
    ...
    ModelParameters.AdhesionSpringConstant = 1; % Change (substrate rigidity)
