...
clear; 
clc;
SaveDirectory = '/uufs/chpc.utah.edu/common/home/u1201504/Desktop/Simulations';    
    
   % Setup all combinations of parameters to be varied  -------------------------------------------------------------------
    values = [];
    nRuns = 3 ; % Total number of runs for each condition
    k_a = [0.0001 0.001 0.010 1]; % adhesion spring constant
    peak = [1 2];   % WT or Mn
    ...
    %parfor k = 1:size(values,1) 
            ...
            ModelParameters.TimeStep = 1e-7;
            % Special Conditions (or edits to ModelParameters) ==============================================================
                ModelParameters.TotalSimulationTime = 2; % seconds
